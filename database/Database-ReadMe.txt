...
3-  Importing database functions:
    ...
    To create, update, delete or read any data from the database, you need to import them to your file using:
        ...
        # Events
            create_event, get_title, get_description, get_date, get_location, get_capacity, get_available_seats,
            update_title, update_description, update_date, update_location, update_capacity, update_available_seats,
            delete_event,
        ...
        Note: You can import print_all_events() function that will print all events in the table. Used for testing purposes.
